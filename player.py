...
frameCnt = 30
frames = [PhotoImage(file='223D.gif', format = 'gif -index %i' %(i)) for i in range(frameCnt)]
...
Buttonhole = PhotoImage(file="volume.png")
Button(root, image=Buttonhole, bg="#FFFFFF", bd=0, height = 60, width =60,
